...
<div class="overview">
	<?php
		...
		while($species = mysqli_fetch_array($y2)){
			...
			$x3 = "SELECT * FROM products where pallet_id = '$pallet_id' AND species_id = '$species_id'";
			...
			if($num_of_products > 0){
				...
				$products2X = "SELECT * FROM `products` WHERE pallet_id='$pallet_id' AND species_id = '$species_id'";
				$products2Y = mysqli_query($conn, $products2X);
				...
				foreach ($CutIDS as &$value) {
					...
					$xK = "SELECT * FROM `products` WHERE pallet_id='$pallet_id' AND species_id='$species_id' AND cut_id='$value'";
					...
					$xD = "SELECT * FROM `products` WHERE pallet_id='$pallet_id' AND species_id='$species_id' AND cut_id='$value'";
					$yD = mysqli_query($conn, $xD);
					$counter = 0;
					while($rowD = mysqli_fetch_array($yD)){
