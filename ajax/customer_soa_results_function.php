...
function precredit_check($customer_id)
{
    ...
    else
    {
        ...
        if ($oldest != "" && $oldest < $gracePeriod)//over grace
        {
            $returningObj['saleAllowed'] = false;
        ...
        else if ($outstanding > $custR['credit_rating'])//over finance
        {
            $returningObj['saleAllowed'] = false;
        ...
        else if ($oldest != "" && $oldest < $beyondDate)//over due
        {
        ...
        else if ($oldest != "" && $oldest < $closeToOverdue)//due soon
        {
            $returningObj['showWarning'] = true;
        ...
        else if ($outstanding > $custR['flaguplimit']) //close to finance
        {
            $returningObj['showWarning'] = true;
