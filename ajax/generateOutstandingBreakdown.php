...
?>
    <tr>
        ...
        <td><?php if ($rollingCurrent != 0)echo $rollingCurrent;?></td>
        <td><?php if ($rollingCloseDate != 0) echo $rollingCloseDate;?></td>
        <td><?php if ($rollingBeyondDate != 0) echo $rollingBeyondDate;?></td>
        <td><?php if ($rollingBeyondGrace != 0) echo $rollingBeyondGrace;?></td>
...
"","
    <tr class="last" style="position: sticky; bottom: 0;">
        ...
        <td></td>
        <td></td>
        <td><?php if ($overallCurrent != 0) echo $overallCurrent;?></td>
        <td><?php if ($overallCloseDate != 0) echo $overallCloseDate;?></td>
        <td><?php if ($overallBeyondDate != 0) echo $overallBeyondDate;?></td>
        <td><?php if ($overallBeyondGrace != 0) echo $overallBeyondGrace;?></td>
        <td><?php echo $total;?></td>
    </tr>
    "]