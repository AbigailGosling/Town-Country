<?php
    ...
    $usersT = mysqli_fetch_all(mysqli_query($conn, $sql),MYSQLI_ASSOC);
    $users = array();
    ...
    $customersT = mysqli_fetch_all(mysqli_query($conn, $sql),MYSQLI_ASSOC);
    $customers = array();
    ...
    $invoice_payments = mysqli_fetch_all(mysqli_query($conn, $sql),MYSQLI_ASSOC);
