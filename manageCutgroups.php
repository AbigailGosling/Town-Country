	...
	<div id="intakelist">
		...
		<?php
			...
			if($_GET['id'] != ''){
				...
				$x = "SELECT * FROM cutgroups WHERE id = '$id'";
		...
		<form method="POST" action="<?php if($_GET['id'] != ''){ echo '/scripts/updateCutgroup.php'; } else { echo '/scripts/addCutgroup.php'; } ?>">

		<table width="100%" border="0" cellpadding="0" cellspacing="0">

			<tr><td align="center"><h1 class="int"><?php if($_GET['id'] != ''){ echo 'UPDATE'; } else { echo 'ADD'; } ?> CUT GROUP</h1></td></tr>
