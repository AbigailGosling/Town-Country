...
<main>
	...
	<div id="intakelist">
		...
		<form method="POST" action="<?php if($_GET['id'] != ''){ echo '/scripts/updateBrand.php'; } else { echo '/scripts/addBrand.php'; } ?>">

		<table width="100%" border="0" cellpadding="0" cellspacing="0">

			<tr><td align="center"><h1 class="int"><?php if($_GET['id'] != ''){ echo 'UPDATE'; } else { echo 'ADD'; } ?> BRAND</h1></td></tr>
