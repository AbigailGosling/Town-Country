                ...
                <slot>
                    @foreach($locations as $location)
                        <tr>
                            ...
                            <x-data-table-column :show-on-mobile="true">{{$location->email}}</x-data-table-column>
                            ...
                            <td class="border-b dark:border-slate-600 p-2 pr-8">
                                <div class="grid-cols-2">
                                    <div class="grid grid-cols-1">
                                        <x-table-action-button route="locations.edit" :id="$location->id"></x-table-action-button>
                                    </div>
                                </div>
                            </td>
                        </tr>
