    ...
    <form method="get" action="{{route('supplierreturnstatements.index')}}">
            ...
            <x-data-table>
                <x-slot:headers>
                    ...
                    <x-data-table-header :show-on-mobile="false">Original Value</x-data-table-header>
                ...
                <slot>
                    @foreach($items as $item)
                        <tr>
                            ...
                            <x-data-table-column :show-on-mobile="false">£{{number_format($item->value,2)}}</x-data-table-column>
                            ...
                            <td class="border-b dark:border-slate-600 p-2 pr-8">
                                <div class="grid-cols-2">
                                    <div class="grid grid-cols-1">
                                        <x-table-action-button route="supplierreturnstatements.show" :id="$item->supplier->id"></x-table-action-button>
                                    </div>
                                </div>
                            </td>
                        </tr>
                ...
                <x-slot:footers>
                    ...
                    <x-data-table-column :show-on-mobile="false">£{{number_format($summary->value,2)}}</x-data-table-column>
