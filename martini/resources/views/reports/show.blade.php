<x-app-layout expand="true">
    ...
    <div style="width:100%">
        <div style="width:100%" class="bg-gray-200 shadow-sm sm:rounded-lg ml-6 mr-6">
            <table style="table-layout: fixed;" class="border-collapse table-auto w-fit text-sm mt-4">
                ...
                <tbody class="bg-white">
                    ...
                    <tr>
                        @foreach($columns as $column)
                        <td align="center">{{App\Helpers\ReportHelper::finaliseCell($column,$row,"debits")}}</td>
                        @endforeach
                    </tr>
                    @endforeach
                </tbody>
        ...
        <div style="width:100%" class="bg-gray-200 shadow-sm sm:rounded-lg ml-6 mr-6">
            <table style="table-layout: fixed;" class="border-collapse table-auto w-fit text-sm mt-4">
                ...
                <tbody class="bg-white">
                    ...
                    <tr>
                        @foreach($columns as $column)
                        <td align="center">{{App\Helpers\ReportHelper::finaliseCell($column,$row,"credits")}}</td>
                        @endforeach
                    </tr>
                    @endforeach
                </tbody>
