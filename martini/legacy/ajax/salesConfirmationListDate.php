<?php
	...
	$pickersheetResults = prepareExecuteQuery("SELECT * FROM `pickerSheets` WHERE `date` BETWEEN ? AND ? ORDER BY `date` DESC",'ss',[$startDate,$endDate]);
                        ...
                        <tr>
                            ...
                            <td align="left" style="font-size: 14px;">
                                <?php
                                    ...
                                    $cusResult = prepareExecuteQuery("SELECT * from `customers` WHERE id=?",'i',[$customer_id]);
