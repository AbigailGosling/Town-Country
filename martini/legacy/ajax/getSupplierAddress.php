...
<div class="col">
	...
	<input class="form-control" type="text" id="supplier_id" name="supplier_id" value="<?php echo $row['id']; ?>" style="display:none;">

	<div>
		<label>Contact Number</label><br/>
		<input class="form-control input box" type="text" id="deliverynumber" name="deliverynumber" value="<?php echo $row['contact_number']; ?>" disabled>
	</div>
    <div>
		<label>Contact Name</label><br/>
		<input class="form-control input box" type="text" id="contactname" name="contactname" value="<?php echo $row['contact_name']; ?>" disabled>
	</div>
</div>
...
$addressNumber = $row['contact_number'];
$addressline1 = $row['address_1'];
$addressline2 = $row['address_2'];
$addressline3 = $row['address_3'];
$addresspostcode = $row['postcode'];
