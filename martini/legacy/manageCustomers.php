		...
		<div class="box">
			...
			<table width="100%" id="customerDetails">
                ...
                <tr id="address<?php echo $ca->address_id ?? $u; ?>collection" style="<?php echo $style1; ?>">
					...
					<td><input type="checkbox" name="address_collection<?php echo $u; ?>" <?php echo ($ca->collection ?? 0 == 1)?"checked":""; ?>></td>
				</tr>
		...
		<div class="fullbox controls">
			<table width="100%">
                ...
                <tr>
					...
					<td><input type="text" class="input" name="insured_credit" value="<?php echo number_format((double)$data['insured_credit'], 2, '.', ''); ?>"></td>
				</tr>
				<tr>
