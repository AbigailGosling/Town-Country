<?php
    ...
    pclose(popen('start /B cmd /C "php D:\\wwwroot\\martini\\artisan run:credit_precheck '.$customer_id.' >NUL 2>NUL"', 'r'));
	//shell_exec("php D:\\wwwroot\\martini\\artisan run:credit_precheck $customer_id > NUL 2>&1 &");
?>
<script>
