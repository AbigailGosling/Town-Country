...
// 			
        ...
        // echo "productID:". $productsRow['productid'] ."<br>";
        // echo 'new total ' . $totalW . "<br>";
        // break;
        // $totalW = weightSoldFromProductID($productsRow['productid']);  
        //  echo 'old total ' . $totalW . "<br>";
        // break;
        ...
        <tr class="searchAccordTitle">
            ...
            <td colspan="1"  onclick="toggleRow('<?php echo $class; ?>');"><?php echo $pallet_id; ?></td>
            ...
            <td><?php 
                ...
                // $yY = prepareExecuteQuery($xX);

                $weightt = $relatedWeights[0];// mysqli_fetch_array($yY);
		...
		if($products2Count > 0){
			...
			<tr style="background:#d9d9d9;display:none;" class="subrow <?php echo $class; ?>">
				...
				// 		$pallet = mysqli_fetch_array($pallety);
					...
					?>
					<form method="post">
						<input type="text" name="location" class="location" value="<?php echo Location::find($productsRow['storage_location'])->name; ?>" placeholder="location" style="width:90px;">
