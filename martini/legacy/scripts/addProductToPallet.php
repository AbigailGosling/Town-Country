<?php
	...
	$x = "INSERT INTO `product` (akg,pallet_id,cut_id,brand_id,nationality_id,cooling_id,range_from,range_to,range_extension,ubbb,unit,best_by,product_temp,comments,health_id) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
	$y = prepareExecuteQuery($x,'ssssssssssssssi',[$akg,$pallet_id,$cut_id,$brand_id,$nationality_id,$temperature_id,$range_from,$range_to,$range_extension,$ubbb,$unit,$best_by,$product_temp,$comments,$health_id]);
