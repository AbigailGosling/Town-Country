...
<script type="text/javascript">
	...
	function doSearch(){
		...
		if(species != '' || cutgroup_id != '' && intakeID != '' || palletID != ''){
			...
			$.get("scripts/searchContainer.php?cutgroup_id=" + cutgroup_id + "&species=" + species +  "&temperatureID=" + temperatureID +  "&palletID=" + palletID + "&intakeID=" + intakeID + "&brandID=" + brand + "&nationalityID=" + nationality + "&time="+time + "&customerID="+customer_id +"&siteID="+siteID , function(data, status){
