...
use App\Http\Controllers\ReturnedStockReportController;
use App\Http\Controllers\SiteController;
use App\Http\Controllers\StockMovementRuleController;
use App\Http\Controllers\TransportPalletController;
use App\Http\Controllers\TransportPalletsLoadingController;
...
Route::middleware(['auth', 'verified', 'permission', 'twofactor'])->group(function () {
    ...
    Route::get('/outgoing-pallets', [TransportPalletController::class, 'index'])->name('outgoing-pallets.index');
    Route::get('/outgoing-pallets/details', [TransportPalletController::class, 'details'])->name('outgoing-pallets.details');
    Route::post('/outgoing-pallets', [TransportPalletController::class, 'createPallet'])->name('outgoing-pallets.create');
    Route::delete('/outgoing-pallets/{outgoingPallet}', [TransportPalletController::class, 'deletePallet'])->name('outgoing-pallets.delete');
    Route::post('/outgoing-pallets/attach-pick', [TransportPalletController::class, 'attachPick'])->name('outgoing-pallets.attach-pick');
    Route::post('/outgoing-pallets/detach-pick', [TransportPalletController::class, 'detachPick'])->name('outgoing-pallets.detach-pick');
    Route::post('/outgoing-pallets/update-type', [TransportPalletController::class, 'updatePalletType'])->name('outgoing-pallets.update-type');
    Route::post('/outgoing-pallets/split-pick', [TransportPalletController::class, 'splitPick'])->name('outgoing-pallets.split-pick');
    Route::post('/outgoing-pallets/render-pick-html', [TransportPalletController::class, 'renderPickHtml'])->name('outgoing-pallets.render-pick-html');
    Route::post('/outgoing-pallets/pick-pallets', [TransportPalletController::class, 'pickPallets'])->name('outgoing-pallets.pick-pallets');
    Route::post('/pods/send', [PodDispatchController::class, 'send'])->name('pods.send');

    // Outgoing Pallets Loading endpoints
    Route::get('/outgoing-pallets-loading', [TransportPalletsLoadingController::class, 'view'])->name('outgoing-pallets-loading.view');
    Route::get('/outgoing-pallets-loading/vehicles', [TransportPalletsLoadingController::class, 'vehicle'])->name('outgoing-pallets-loading.vehicles');
    Route::get('/outgoing-pallets-loading/vehicle-details', [TransportPalletsLoadingController::class, 'vehicleDetails'])->name('outgoing-pallets-loading.vehicle-details');
    Route::get('/outgoing-pallets-loading/vehicle-allocations', [TransportPalletsLoadingController::class, 'vehicleAllocations'])->name('outgoing-pallets-loading.vehicle-allocations');
    Route::get('/outgoing-pallets-loading/load-sheets', [TransportPalletsLoadingController::class, 'loadSheets'])->name('outgoing-pallets-loading.load-sheets');
    Route::post('/outgoing-pallets-loading/update-allocation', [TransportPalletsLoadingController::class, 'updateAllocation'])->name('outgoing-pallets-loading.update-allocation');
    Route::post('/outgoing-pallets-loading/update-pallet-type', [TransportPalletsLoadingController::class, 'updatePalletType'])->name('outgoing-pallets-loading.update-pallet-type');
    Route::post('/outgoing-pallets-loading/commit-allocations', [TransportPalletsLoadingController::class, 'commitAllocations'])->name('outgoing-pallets-loading.commit-allocations');
    Route::get('/outgoing-pallets-loading/print-truck-load', [TransportPalletsLoadingController::class, 'printTruckLoad'])->name('outgoing-pallets-loading.print-truck-load');
    Route::get('/outgoing-pallets-loading/pallet-selection', [TransportPalletsLoadingController::class, 'palletSelection'])->name('outgoing-pallets-loading.pallet-selection');
    Route::get('/outgoing-pallets-loading/pallet-overview', [TransportPalletsLoadingController::class, 'palletOverview'])->name('outgoing-pallets-loading.pallet-overview');
    Route::get('/outgoing-pallets-loading/orders', [TransportPalletsLoadingController::class, 'orders'])->name('outgoing-pallets-loading.orders');
    Route::get('/outgoing-pallets-loading/depots', [TransportPalletsLoadingController::class, 'depots'])->name('outgoing-pallets-loading.depots');
