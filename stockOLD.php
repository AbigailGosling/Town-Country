    ...
    <form method="POST" id="searchForm">
        <select id="SearchSpecies" name="species" style="width:322px;height:40px;">
            ...
            <?php
                ...
                ?><option value="<?php echo $row['id']; ?>" <?php if($_POST['species'] == $row['id']){ echo 'selected'; } ?>><?php echo $row['name']; ?></option><?php
                }
            ?>
        </select>
            ...
            <?php
                ...
                while($row = mysqli_fetch_array($y)){
                    ...
                    $rand = 'z' . rand(6000,12212);
                        ?><option style="display:none;" sid="<?php echo $row['id']; ?>" class="allsoption s<?php echo $species['id']; ?>" value="<?php echo $row['id']; ?>"<?php if($_POST['cutgroup_id'] == $row['id']){ echo 'selected'; } ?>><?php echo $row['name']; ?></option><?php
                    }
            ?>
        </select>
    </form>	
	<div id="loadResults" class="resultsContainer">
        <?php if($_POST['cutgroup_id']){ ?>        
