<?php
	...
	, nameofbuyer='$nameofbuyer', contactnumber='$contactnumber', customer_email='$customer_email', salesman='$salesman', companyregno='$companyregno', accounts_address_1='$accounts_address_1'
	...
	, current_outstanding='$current_outstanding',address1_number='$address1_number',address2_number='$address2_number',address3_number='$address3_number' WHERE id='$id' LIMIT 1";
